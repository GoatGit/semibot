"""Legacy standalone executor agent implementation.

The active runtime execution path is `orchestrator.nodes.act_node`.
...
from src.orchestrator.execution import is_critical_failure
from src.orchestrator.executor import execute_parallel, execute_single
