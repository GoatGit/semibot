...
class WebFetchTool(BaseTool):
    ...
    def __init__(self) -> None:
        self.timeout_ms = int(os.getenv("SEMIBOT_WEB_FETCH_TIMEOUT_MS") or "12000")
        self.max_chars = int(os.getenv("SEMIBOT_WEB_FETCH_MAX_CHARS") or "20000")
    ...
    def description(self) -> str:
        return (
            "Fetch a specific webpage over HTTP and extract title, main text, and optional links/HTML. "
            "Use this for direct page reading; it does not perform browser interaction or JS-driven workflows."
        )
        ...
        return {
            ...
            "properties": {
                ...
                "mode": {
                    ...
                    "description": "readability extracts main article/body text; raw uses the full HTML body as the extraction source.",
                    "default": "readability",
                },
                "timeout_ms": {"type": "integer", "description": "HTTP timeout in milliseconds."},
                "max_chars": {"type": "integer", "description": "Maximum extracted text length. Longer text is truncated and marked with truncated=true."},
                "include_links": {"type": "boolean", "description": "Whether to return a deduplicated links array.", "default": True},
                "include_html": {"type": "boolean", "description": "Whether to include extracted HTML in html/html_truncated fields.", "default": False},
            },
            "required": ["url"],
        }
        ...
        **_: Any,
        ...
        try:
            ...
            return ToolResult.error_result(
                f"web_fetch request failed: {type(exc).__name__}: {details}"
            )
