...
from src.orchestrator.nodes_plan import _filter_rule_authoring_by_intent
...
def test_filter_rule_authoring_removed_for_normal_chat() -> None:
    # Disabled: _filter_rule_authoring_by_intent always returns the original list unchanged
    schemas = [
