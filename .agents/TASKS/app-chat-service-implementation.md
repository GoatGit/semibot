...
**Type:** Feature
**Status:** In Progress (核心功能已完成，测试待补充)
...
- [x] 创建 `llm.service.ts` LLM Provider 抽象层
- [x] 实现 OpenAI Provider
- [x] 实现 Anthropic Provider (可选)
- [ ] 实现 DeepSeek Provider (可选)
- [x] 修改 `chat.service.ts` 移除模拟延迟
- [x] 集成 LLM Provider 调用
- [x] 实现 SSE 流式输出
- [x] 实现 Provider Fallback 机制
- [x] 添加 Token 使用量记录
- [x] 添加错误处理和超时控制
- [ ] 编写单元测试 (覆盖率 > 80%)
- [ ] 编写集成测试
