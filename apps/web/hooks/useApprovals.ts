...
function normalizeApproval(raw: unknown): ApprovalRecord | null {
  ...
  return {
    ...
    sessionId: readString(raw.sessionId) || readString(raw.session_id) || undefined,
    attemptId: readString(raw.attemptId) || readString(raw.attempt_id) || undefined,
    userMessageId: readString(raw.userMessageId) || readString(raw.user_message_id) || undefined,
