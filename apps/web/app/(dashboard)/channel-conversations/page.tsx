...
type GatewaySource = 'telegram' | 'feishu' | 'discord' | 'whatsapp' | 'imessage' | 'channel'
      ...
      sortedConversations.forEach((conversation) => {
        ...
        if (conversation.latestRun) {
          ...
          group.runs.push({
            ...
            href: `${baseHref}&runId=${encodeURIComponent(run.runId)}`,
          })
        ...
        <Card className="border-border-default">
          <CardContent className="p-4 space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {(['all', 'telegram', 'feishu', 'discord', 'whatsapp', 'imessage', 'channel'] as const).map((value) => (
                <button
                  key={value}
                  type="button"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs text-text-tertiary">
                          ...
                          {group.botIds.length > 0 && (
                            <span>{t('dashboard.channelDetail.botId')}: {group.botIds.join(', ')}</span>
                          )}
                        </div>
                      </div>
                      {group.runs[0] && (
