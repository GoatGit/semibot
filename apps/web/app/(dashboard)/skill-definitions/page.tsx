...
import { Search, Plus, History, RefreshCw, AlertCircle, Package, Loader2 } from 'lucide-react'
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="col-span-2">
                          ...
                          <span className="ml-2 font-mono text-xs text-text-secondary">{version.checksumSha256.substring(0, 16)}...</span>
                        </div>
                        {version.sourceUrl && (
                          <div className="col-span-2">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-bg-surface border border-border-default rounded-lg max-w-lg w-full">
            ...
            <div className="p-6 border-t border-border-subtle flex justify-end gap-2">
              ...
              <Button onClick={handleInstall} loading={actionLoading} disabled={!installVersion}>
                安装
              </Button>
            </div>
          </div>
