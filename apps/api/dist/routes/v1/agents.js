 ...
 */
router.post('/', authenticate, combinedRateLimit, requirePermission('agents:write'), validate(createAgentSchema, 'body'), asyncHandler(async (req, res) => {
 ...
 */
router.get('/', authenticate, combinedRateLimit, requirePermission('agents:read'), validate(listAgentsQuerySchema, 'query'), asyncHandler(async (req, res) => {
    const orgId = req.user.orgId;
 ...
 */
router.get('/:id', authenticate, combinedRateLimit, requirePermission('agents:read'), asyncHandler(async (req, res) => {
    const orgId = req.user.orgId;
 ...
 */
router.put('/:id', authenticate, combinedRateLimit, requirePermission('agents:write'), validate(updateAgentSchema, 'body'), asyncHandler(async (req, res) => {
    const orgId = req.user.orgId;
    const agentId = req.params.id;
    const input = req.body;
 ...
 */
router.delete('/:id', authenticate, combinedRateLimit, requirePermission('agents:write'), asyncHandler(async (req, res) => {
    const orgId = req.user.orgId;
    const agentId = req.params.id;
