...
import { combinedRateLimit, createRateLimit } from '../../middleware/rateLimit'
...
import {
  SKILL_INSTALL_RATE_LIMIT_PER_MINUTE,
  SKILL_INSTALL_RATE_LIMIT_WINDOW_MS,
} from '../../constants/config'

const router: Router = Router()
const skillDefinitionsLogger = createLogger('skill-definitions-route')

const installRateLimit = createRateLimit({
  limit: SKILL_INSTALL_RATE_LIMIT_PER_MINUTE,
  windowMs: SKILL_INSTALL_RATE_LIMIT_WINDOW_MS,
  message: '技能安装操作过于频繁，请稍后再试',
})
