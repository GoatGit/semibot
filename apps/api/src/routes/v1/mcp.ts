...
router.post(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const server = await mcpService.createMcpServer(userId, input)
...
router.get(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const result = await mcpService.listMcpServers(options)
...
router.put(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const existing = await mcpService.getMcpServer(serverId)
    ...
    const server = await mcpService.updateMcpServer(serverId, input)
...
router.post(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const server = await mcpService.syncToolsAndResources(serverId, tools, resources)
