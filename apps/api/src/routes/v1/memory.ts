...
router.get(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const result = await memoryService.listMemories(options)
...
router.post(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const memories = await memoryService.searchSimilarMemories(input)
...
router.post(
  ...
  asyncHandler(async (_req: AuthRequest, res: Response) => {
    const count = await memoryService.cleanupExpiredMemories()
