...
router.get(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const result = await logsService.listExecutionLogs(options)
...
router.get(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const result = await logsService.listUsageRecords(options)
...
router.get(
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const summary = await logsService.getUsageSummary(periodType, startDate, endDate)
