...
/** 服务器端口 */
export const SERVER_PORT = process.env.API_PORT ? parseInt(process.env.API_PORT, 10) : 3001
...
/** Skill 安装接口限流：每分钟最大请求数 */
export const SKILL_INSTALL_RATE_LIMIT_PER_MINUTE = 5

/** Skill 安装接口限流窗口 (毫秒) */
export const SKILL_INSTALL_RATE_LIMIT_WINDOW_MS = 60000
...
export const SINGLE_USER_ORG_ID = process.env.SEMIBOT_SINGLE_ORG_ID || '11111111-1111-1111-1111-111111111111'
export const SINGLE_USER_USER_ID = 'local-user'
